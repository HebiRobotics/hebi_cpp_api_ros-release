## hebi_cpp_api_ros (kinetic) - 3.2.0-2

The packages in the `hebi_cpp_api_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release hebi_cpp_api_ros --rosdistro kinetic` on `Thu, 28 May 2020 17:27:58 -0000`
...
## hebi_cpp_api_ros (kinetic) - 3.2.0-1

The packages in the `hebi_cpp_api_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release hebi_cpp_api_ros --rosdistro kinetic` on `Fri, 03 Apr 2020 19:01:42 -0000`
...
## hebi_cpp_api_ros (melodic) - 3.2.0-1

The packages in the `hebi_cpp_api_ros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release hebi_cpp_api_ros --rosdistro melodic` on `Fri, 03 Apr 2020 18:57:40 -0000`
...
## hebi_cpp_api_ros (melodic) - 3.1.1-1

The packages in the `hebi_cpp_api_ros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release hebi_cpp_api_ros --rosdistro melodic` on `Mon, 16 Dec 2019 21:32:07 -0000`
...
## hebi_cpp_api_ros (kinetic) - 3.1.1-1

The packages in the `hebi_cpp_api_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release hebi_cpp_api_ros --rosdistro kinetic` on `Mon, 16 Dec 2019 21:27:25 -0000`
...
## hebi_cpp_api_ros (melodic) - 3.1.0-1

The packages in the `hebi_cpp_api_ros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release hebi_cpp_api_ros --rosdistro melodic` on `Wed, 04 Dec 2019 18:37:15 -0000`
...
## hebi_cpp_api_ros (kinetic) - 3.1.0-1

The packages in the `hebi_cpp_api_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release hebi_cpp_api_ros --rosdistro kinetic` on `Wed, 04 Dec 2019 18:01:42 -0000`
...
## hebi_cpp_api_ros (melodic) - 2.1.0-1
